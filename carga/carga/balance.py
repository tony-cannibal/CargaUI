...
def balance(maquinas: dict,
            carga: pandas.core.frame.DataFrame,
            tipo: str, area: str, con: dict) -> pandas.core.frame.DataFrame:
    '''Returns the balance between the input and capacity of each machine
